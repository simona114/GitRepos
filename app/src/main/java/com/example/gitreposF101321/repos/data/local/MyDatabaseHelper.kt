...
class MyDatabaseHelper(context: Context) :
    ...
    override fun onCreate(database: SQLiteDatabase) {
        val createTableStatement =
            "CREATE TABLE $TABLE_REPOSITORIES ($COLUMN_REPOSITORY_ID TEXT NOT NULL PRIMARY KEY , " +
                    "$COLUMN_REPOSITORY_TITLE TEXT NOT NULL,$COLUMN_REPOSITORY_OWNER TEXT NOT NULL," +
                    "$COLUMN_REPOSITORY_LANGUAGE TEXT NOT NULL,$COLUMN_REPOSITORY_LINK TEXT NOT NULL);"
